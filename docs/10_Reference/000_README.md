# 📚 000_REFERENCE_README (참조 자료 인덱스)

> **문서 ID**: 000  
> **분류**: 🔍 참조 & 외부  
> **목적**: 프로젝트 전반에 걸친 정책 및 통합 가이드라인 참조 관리  
> **대상**: 모든 팀원, Audit Agent, CIO  
> **작성일**: 2026-04-18  
> **최종 수정**: 2026-04-18  
> **작성자**: CIO (AI Agent)  
...
## 📌 개요
이 폴더는 ZENITH_LMS 프로젝트의 법적, 절차적, 정책적 참조 자료들을 보관합니다. 통합 문서 작성 가이드 및 준수해야 할 감사 관리 정책 등이 포함됩니다.
