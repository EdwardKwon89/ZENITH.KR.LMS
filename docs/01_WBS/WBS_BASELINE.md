# WBS BASELINE: 초기 설계 기준

> **성격**: 프로젝트 초기 설계 기준 (마스터/불변)
> **작성일**: 2026-04-16
> **버전**: v1.0
> **작성자**: Antigravity
> **참조**: [.planning/detailed_WBS.md](../../.planning/detailed_WBS.md) (현재 LIVE 문서)

---

## 📌 안내

이 파일은 프로젝트 **초기 설계 기준**입니다.

- **현재 진행 현황**: [.planning/detailed_WBS.md](../../.planning/detailed_WBS.md) 참고
...
#### 1.2 [Master Data] 공통 코드 및 기준 정보 (10 MD)
...
- **1.3.1 Supabase Auth 기반 인증** (4 MD)
  - 1.3.1.1 API 명세 수립 (Auth/Login/Join) (1 MD)
