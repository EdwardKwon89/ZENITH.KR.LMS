...
| **UAT 관리자** | `admin@zenith.kr` | `password1234` | ADMIN | UAT 마스터 계정 (UAT_MASTER.md 기준) |
| **UAT 법인 화주** | `uat02_corp_shipper@zenith.kr` | `password1234` | CORPORATE | UAT-17 DIRECT/PICKUP 검증용 |
| **UAT 대리점** | `agency@zenith.kr` | `password1234` | AGENCY | UAT-15/16/17-03/20 검증용 (AGENCY A) |
