...
| TASK-B-116 | 260713 | Issue #429 — STATIC_PERMISSIONS에 /address-book 추가 (주소록 메뉴 접근 불가 수정) | P2 | 없음 | Baker (구현) | 🔄 | [TASK-B-116](tasks/TASK-B-116_260713_Iss429_StaticPermissions_addressbook_Baker.md) | 모든 역할 12종에 /address-book 경로 추가 · 회귀 485/485 PASS · PR#431 재제출 |
