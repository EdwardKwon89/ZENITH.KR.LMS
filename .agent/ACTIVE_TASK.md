...
| TASK-B-126 | 260715 | Issue #480 — AddressBook RLS 조건 패턴 수정 | P1 | 없음 | Mike (구현) | 🔔 | [TASK-B-126](tasks/TASK-B-126_260715_Iss480_AddressBookRLS_Mike.md) | existingRows 조회: .match(owner) → .eq()+.is() 패턴 교체 · insertPath 조회: 동일 패턴 교체 · error 구조분해 확인 추가 · Build PASS ✅ · Regression 81/81 ALL PASS (490 tests) · PR#481 |
