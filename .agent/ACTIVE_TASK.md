...
| TASK-B-089 | 260710 | Issue #310 — Zone별 할인율 체계 전환 (rate_overrides 폐기, Admin UI Zone 매트릭스) | P2 | 없음 | Dave (구현) | 🔔 | [TASK-B-089](tasks/TASK-B-089_260710_ISS310_ZoneDiscounts_Dave.md) | rate_overrides 폐기·zone_id 추가·zen_agency_shipper_zone_discounts 신설 · Jaison 2차 검토 통과, Aiden mergeable 해소 대기 · 회귀 **489/489 ALL PASS** ✅ · PR#314 |
>>>>>>> 7eac1a38 ([Dave] feat: TASK-B-086 Zone별 할인율 체계 전환 — rate_overrides 폐기, Admin UI Zone 매트릭스, 테스트 정합)
