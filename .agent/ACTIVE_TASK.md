...
| TASK-B-104 | 260712 | Issue #350 — Agency 할인율 정책 조회 화면 결함 3종 수정 (Zone 표시·대리점 검색·부피중량) | P1 | 없음 | Mike (구현) | 🔔 | [TASK-B-104](tasks/TASK-B-104_260712_Iss350_AgencyPolicyFix_Mike.md) | page.tsx zone 조인 추가 · AgencyPolicyTable 검색+부피중량 컬럼 추가 · Build PASS ✅ · Regression 78/81 PASS (3건 환경변수 무관) · PR#374 |
