...
| TASK-B-030 | 260627 | [Phase 8] DEF-080 country_code ISO 2→3 변환 누락 수정 (IMP-142) | P1 | TASK-B-025 ✅ | JSJung (검토) · Baker (구현) | 🔔 | [TASK-B-030](tasks/TASK-B-030_260627_DEF080_country_code_ISO변환_Baker.md) | Issue #128 · IMP-142 · DEF-080 · ups-labels.ts toIso3() 추가 · 380/387 PASS · PR#129 🔔 |
---
...
| 2026-06-27 | Baker (Big Pickle) | **TASK-B-030 🔔 완료** — toIso3() 헬퍼 추가 · ups-labels.ts ISO 2→3 변환 · a68753c · 380/387 PASS (7건 pre-existing). Jaison 검토 요청. |
