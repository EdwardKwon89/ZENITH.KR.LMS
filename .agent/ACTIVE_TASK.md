...
| TASK-B-093 | 260711 | Issue #329 — Agency 기준요금 원가 표시 스타일 통일 + NAVI menu명 오류 정정 | P3 | 없음 | Baker (구현) | 🔔 | [TASK-B-093](tasks/TASK-B-093_260711_ISS329_NaviStyleFix_Baker.md) | UpsBaseRateMatrix agency cost `text-[10px]` 괄호 · `agency_other_charges_nav` → "부가요금 조회" (ko/zh/ja) · 회귀 **489/489 ALL PASS** ✅ · PR#331 |
