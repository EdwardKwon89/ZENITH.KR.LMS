...
| TASK-B-155 | 260717 | Issue #567 — DEF-102 CSP connect-src data: 추가 | P1 | 없음 | Baker (구현) | 🔔 | [TASK-B-155](tasks/TASK-B-155_260717_DEF102_CSPConnectSrc_Baker.md) | next.config.ts connect-src에 data: 추가 · 회귀 95/95 ALL PASS (594 tests) |
