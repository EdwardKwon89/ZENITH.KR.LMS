...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#1154](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1154) | TASK-B-315: 오더등록 검증 실패 토스트 — 중첩 필드(packages/items) leaf 메시지 표출 (DEF-B-140) | b | p2 | - | jungjs | 2026-08-17 |
