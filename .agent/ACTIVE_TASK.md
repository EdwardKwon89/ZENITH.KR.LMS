...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#1137](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1137) | TASK-B-307: 영문 주소 표출 — state/country 원시코드→이름 변환 + 화주 주소 중복 제거 (DEF-B-136) | b | p2 | - | jungjs | 2026-08-16 |
