...
| TASK-124 | 260609 | IMP-108 §1+§3 max_charge 상한선 구현 (WM Cap + UI) | P2 | TASK-123 ✅ | D_Kai + B_Kai | 🔔 | [TASK-124](tasks/TASK-124_260609_IMP108MaxCharge구현_DKai_BKai.md) | §1 B_Kai ✅ `ce17476` · §3 D_Kai ✅ `9d70d87` · build PASS + 315/315 PASS |
...
|:------|:--------|:----------------|:----------|
| **D_Kai (OpenCode)** | TASK-124 §3 **🔔** `9d70d87` Aiden 검토 대기 | — | TASK-125 🚫 (TASK-124 🔔 대기) |
| **B_Kai** | TASK-124 §1 ✅ `ce17476` | — | §3 D_Kai `🔔` 대기
