...
| TASK-125 | 260609 | IMP-107 TISA 요율 스냅샷 강화 (WM slab 이력 + pricing_basis 저장) | P3 | TASK-124 ✅ | D_Kai | ⬜ | [TASK-125](tasks/TASK-125_260609_IMP107TISA스냅샷강화_DKai.md) | IMP-107 — TASK-124 ✅ 해제 · D_Kai 착수 가능 |
...
|:------|:--------|:----------------|:----------|
| **D_Kai (OpenCode)** | TASK-125 **⬜** 즉시 착수 가능 | — | — |
| **B_Kai** | — | — | 신규 Task 대기 |
