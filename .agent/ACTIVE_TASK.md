...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#1199](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1199) | [Aiden] IMP: 워크트리 격리 자동검증 — commit-msg 훅 확장 (Issue #1165/TASK-B-318 재발 방지) | a | p2 | - | 미배정 | 2026-09-17 |
| [#1196](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1196) | [Team B] TASK-B-327: SHXK 무역서류(운송장/INV/세관신고서) 처리 완료 메시지 부재 + INVOICE 문서유형 매핑 의심 (DEF-B-147, Medium) | b | p2 | - | jungjs | 2026-09-13 |
...
| [#1165](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1165) | [Team B] TASK-B-318: SHXK 실운영 인증키 미등록으로 UPS 발송 전량 실패 (DEF-B-142, Critical) | a | p2 | review | EdwardKwon89 | 2026-09-17 |
