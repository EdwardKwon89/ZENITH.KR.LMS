...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#432](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/432) | [feat] UPS Direct 오더 등록 — 2/3단계(서비스 선택/요율 확인) 건너뛰고 1단계에서 바로 저장 | b | p2 | - | 미배정 | 2026-07-13 |
| [#429](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/429) | [fix] 주소록 메뉴 접근 불가 — /address-book 경로가 역할별 허용 경로에 미포함 | b | p2 | - | 미배정 | 2026-07-13 |
...
| TASK-B-116 | 260713 | Issue #429 — STATIC_PERMISSIONS에 /address-book 추가 (주소록 메뉴 접근 불가 수정) | P2 | 없음 | Baker (구현) | 🔔 | [TASK-B-116](tasks/TASK-B-116_260713_Iss429_StaticPermissions_addressbook_Baker.md) | 모든 역할 12종에 /address-book 경로 추가 · 회귀 485/485 PASS · CI PASS · 스크린샷 검증 완료 · PR#431 재제출 |
