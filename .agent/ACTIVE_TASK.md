...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#1156](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1156) | [fix] DEF-B-141 — 출고확정 시 대리점 자가화주 오더 인보이스 생성 실패 (TASK-B-316) | b | p1 | in-progress | jungjs | 2026-08-17 |
