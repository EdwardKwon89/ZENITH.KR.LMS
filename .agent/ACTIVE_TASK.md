...
| TASK-B-055 | 260705 | UAT-16 결함 수정 — 요율 오버라이드 신규 등록 폼 기준요율 드롭다운 UUID 표시 | P1 | 없음 | Baker (구현) | ⬜ | [TASK-B-055](tasks/TASK-B-055_260705_UAT16_RateOverrides_기준요율드롭다운UUID표시수정_Baker.md) | UAT-16-01 Step2 결함 · getUpsBaseRates join 추가 + 드롭다운 코드명 표시 |
...
| **Baker** (AI Agent) | ⬜ TASK-B-055 착수 대기 | UAT-16-01 결함 수정 — 기준요율 드롭다운 UUID → 코드명 표시 |
