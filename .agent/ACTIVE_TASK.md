...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#1178](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1178) | [Team A] TASK-1138: 애플리케이션 로그/에러 추적 SaaS 연동 — Axiom(전체 로그) + Sentry(에러 전용) | a | p3 | in-progress | 미배정 | 2026-08-22 |
