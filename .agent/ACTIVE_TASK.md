...
| TASK-B-107 | 260712 | Issue #391 (1단계) — UPS 요금 스케줄링 DB 마이그레이션 (schedule + audit_log) | P1 | 없음 | Mike (구현) | 🔔 | [TASK-B-107](tasks/TASK-B-107_260712_Iss391_PricingScheduleMigration_Mike.md) | zen_ups_pricing_schedule 테이블 + RLS · zen_ups_pricing_setting_audit_log 테이블 + RLS · Build PASS ✅ · PR#389 |
