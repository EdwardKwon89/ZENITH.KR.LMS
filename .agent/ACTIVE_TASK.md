...
| TASK-B-099 | 260711 | Issue #347 — 할인율/할증률 부동소수점 오차 수정 (Math.round 반올림) | P3 | 없음 | Mike (구현) | 🔔 | [TASK-B-099](tasks/TASK-B-099_260711_Iss347_FloatingPointFix_Mike.md) | 4개 파일 Math.round 반올림 · 회귀 **489/489 ALL PASS** ✅ · PR#353 |
