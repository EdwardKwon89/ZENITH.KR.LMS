...
| [#351](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/351) | [feat] Agency → 화주(법인) 할인율 적용 기능 신설 (Zone별) + 화주 등록/수정 화면 개선 | b | p1 | review | 미배정 | 2026-07-11 |
...
| TASK-B-102 | 260711 | Issue #351 — Agency→화주 Zone별 할인율 설정 + 단일 할인율 입력 제거 | P1 | 없음 | Dave (구현) | 🔔 | [TASK-B-102](tasks/TASK-B-102_260711_Iss351_zoneDiscounts_Dave.md) | zone-discounts action · ZoneDiscountForm 신설 · discount_rate 필드 제거 · CI PASS ✅ · PR#365 |
| TASK-B-103 | 260712 | Issue #340 — syncAuthMetadata 확장 + changeMemberGrade 적용 + 전수 점검 | P1 | 없음 | Dave (구현) | 🔔 | [TASK-B-103](tasks/TASK-B-103_260711_Iss340_syncAuthV2_Dave.md) | AuthMetadata grade_code 추가 · changeMemberGrade sync 적용 · audit SQL · CI PASS ✅ · PR#368 |
