...
| TASK-103 | 260531 | TISA 요율 3계층 구조 도입 (carrier_cost+margin+platform_fee) | P1 | 없음 | D_Kai | ❌ | [TASK-103](tasks/TASK-103_260531_TISA요율3계층구조_DKai.md) | IMP-092 · DEF-035 · 반려 — transport_mode 필터 누락·트리거 하드코딩·DoD 미체크 |
...
| D_Kai | TASK-103 ❌ 재작업 중 | R-17 위반 1회 (TASK-103 코드 커밋 ACTIVE_TASK 혼합, 재교육 후 누적) | TASK-104 (TASK-103 완료 대기) |
