...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#1133](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1133) | TASK-B-305: 영문 주소 출력 규칙 통일 — 화주/수하인 주소 영문 우선 표출 + 상세주소 영문전용 입력 (DEF-B-134 포함) | b | p2 | review | jungjs | 2026-08-16 |
