...
| TASK-B-054 | 260705 | UAT-16 블로커 수정 — rate-overrides 서버 `t` 함수 클라이언트 전달 500 에러 | P1 | 없음 | Baker (구현) | ⬜ | [TASK-B-054](tasks/TASK-B-054_260705_UAT16_RateOverrides_서버t함수클라이언트전달수정_Baker.md) | UAT-16 수행 블로커 · page.tsx→Client 5개 파일 `useTranslations()` 전환 |
...
| **Baker** (AI Agent) | ⬜ TASK-B-054 착수 대기 | UAT-16 블로커 수정 — rate-overrides 500 에러 · `useTranslations()` 전환 |
