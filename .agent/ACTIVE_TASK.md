...
| TASK-B-163 | 260718 | Issue #586 — DEF-108 SHXK getnewlabel/removeorder reference_no 하이픈 제거 | P1 | 없음 | Baker (구현) | 🔔 | [TASK-B-163](tasks/TASK-B-163_260718_Def108_RefNoHyphenStrip_Baker.md) | DEF-108 해소 · ups-labels.ts 5곳 수정 · getnewlabel/removeorder/previewShxkPayload · 회귀 95/95 ALL PASS 620 tests · [PR#595](https://github.com/EdwardKwon89/ZENITH.KR.LMS/pull/595) (base: TeamB_Dev) |
| TASK-B-164 | 260718 | Issue #587 — 오더 수정 페이지 신설 + updateOrder 필드 보완 (DEF-109) | P1 | 없음 | Dave (구현) | 🔔 | [TASK-B-164](tasks/TASK-B-164_DEF109_오더수정페이지.md) | 코드 `187c67ff`+`c520183c` · updateOrder 14개 필드 보완 · edit/page.tsx 신규 · OrderRegistrationForm edit 모드 지원 · 오더 상세 "Edit" 버튼 추가 · 619/619 ALL PASS · CI ✅ · **TeamB_Dev 병합 완료(PR#593, 260718) — Jaison 승인, develop 배치병합·최종 ✅는 Aiden 대기** |
| TASK-B-165 | 260718 | Issue #590 — 화주(Shipper) 급증 수수료(Surge Fee) 조회 탭 추가 | P2 | 없음 | Mike (구현) | 🔔 | [TASK-B-165](tasks/TASK-B-165_260718_Iss590_ShipperSurgeFeeTab_Mike.md) | 코드 `ab2e1264` · 626/626 ALL PASS · PR 생성 대기 |
| TASK-B-166 | 260718 | Issue #597 — DEF-110 createorder reference_no 하이픈 제거 | P1 | 없음 | Baker (구현) | 🔔 | [TASK-B-166](tasks/TASK-B-166_260718_Def110_CreateOrderRefNoHyphenStrip_Baker.md) | DEF-110 해소 · label-mapping.ts 1곳 수정 · buildCreateOrderPayload reference_no · 회귀 97/97 ALL PASS 629 tests · PR 대기 |
