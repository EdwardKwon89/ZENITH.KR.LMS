...
| TASK-B-100 | 260711 | Issue #294 — packing_count 의미 불일치 (UPS 1-package 제약 Zod refine) | P1 | 없음 | Dave (구현) | 🔔 | [TASK-B-100](tasks/TASK-B-100_260711_Iss294_packingCount_Dave.md) | UPS 서비스 packages.length===1 refine · physical_box_count schema 추가 · form appendPackage 수정 · build PASS ✅ |
