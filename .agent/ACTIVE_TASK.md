...
| TASK-B-102 | 260712 | Issue #350 — Agency 할인율 정책 조회 결함 3종 (Zone 표시·대리점 검색·부피중량 컬럼) | P2 | 없음 | Mike (구현) | 🔔 | [TASK-B-102](tasks/TASK-B-102_260712_Iss350_AgencyPolicyFix_Mike.md) | page.tsx zone 조인 · 대리점명 검색 · volumetric_divisor 컬럼 · 회귀 **485/485 ALL PASS** ✅ · PR#367 |
