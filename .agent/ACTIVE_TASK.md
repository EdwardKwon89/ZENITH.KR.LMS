...
| TASK-B-134 | 260716 | Issue #518 — UPS 요금 스케줄링 배치 UTC→KST 기준 변경 | P2 | 없음 | Baker (구현) | 🔔 | [TASK-B-134](tasks/TASK-B-134_260716_Iss518_PricingScheduleKst_Baker.md) | getKstToday() 함수 추출(en-CA 로케일 KST YYYY-MM-DD) · route.ts today 계산 KST 기준 · vercel.json cron 0 0→0 15 · KST 테스트 8건(경계 시간대 포함) · Build PASS · Regression 85/85 PASS (530 tests) · 코드 `488ba4a6` · PR#519 |
