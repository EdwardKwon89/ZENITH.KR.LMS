...
| TASK-092 | 260525 | 303 Stage 1+2: Route Decomposer + TISA 캐리어별 요율 매핑 | P2 | TASK-088 ✅ | Riley | ❌ | [TASK-092](tasks/TASK-092_260525_복합운임Stage1Stage2_Riley.md) | IMP-086 · DoD 해시 미기재 + 혼합 커밋 반려 · 최소 재작업 지시 |
...
|:------|:--------|:----------------|:----------|
| Riley | TASK-092 ❌ (IMP-086 — DoD 해시 미기재 재작업) | R-17 위반 2회 누적 (TASK-088 무단 수정·TASK-092 혼합 커밋+해시 미기재) | — |
