...
| TASK-B-164 | 260718 | Issue #587 — 오더 수정 페이지 신설 + updateOrder 필드 보완 (DEF-109) | P1 | 없음 | Dave (구현) | 🔔 | [TASK-B-164](tasks/TASK-B-164_DEF109_오더수정페이지.md) | 코드 `405e3a3a` · updateOrder 14개 필드 보완 · edit/page.tsx 신규 · OrderRegistrationForm edit 모드 지원 · 오더 상세 "Edit" 버튼 추가 · 619/619 ALL PASS · PR#593 🔔
