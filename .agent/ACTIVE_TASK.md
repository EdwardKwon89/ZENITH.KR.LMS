...
| TASK-103 | 260531 | TISA 요율 3계층 구조 도입 (carrier_cost+margin+platform_fee) | P1 | 없음 | D_Kai | 🔔 | [TASK-103](tasks/TASK-103_260531_TISA요율3계층구조_DKai.md) | IMP-092 · DEF-035 · 재작업 완료(`8132d98`) — transport_mode 필터·트리거 fix + DoD 전량 체크 |
| TASK-104 | 260531 | TISA Dashboard 실 Rate Card 연동 (Mock 제거·DB 실조회) | P1 | TASK-103 ✅ | D_Kai | 🔔 | [TASK-104](tasks/TASK-104_260531_TISADashboard실연동_DKai.md) | IMP-093 · DEF-032 · UAT 진행 전 필수 |
...
| D_Kai | TASK-103 🔔 재작업 완료 — Aiden 검토 대기 | R-17 위반 1회 (TASK-103 코드 커밋 ACTIVE_TASK 혼합, 재교육 후 누적) | TASK-104 🔔 (TASK-103 승인 대기) |
