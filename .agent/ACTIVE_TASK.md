...
| TASK-154 | 260617 | DEF-067 seed_data.sql + seed_rate_card.sql 구스키마 수정 + IMP-120 migration fix — CI 전체 차단 블로커 복구 | P1 | 없음 | D_Kai | 🔔 | [TASK-154](tasks/TASK-154_260617_DEF067_시드데이터스키마수정_DKai.md) | DEF-067 · Issue #27 · 코드 db63986 · 378/378 PASS |
...
| **D_Kai (OpenCode)** | 🔔 TASK-152 · TASK-154 검토 대기 | PR #29 (Closes #24) · TASK-154: PR pending (Closes #27) · 코드 db63986 · 378/378 PASS · DEF-067 복구 + seed_rate_card.sql + IMP-120 migration 추가 수정 |
