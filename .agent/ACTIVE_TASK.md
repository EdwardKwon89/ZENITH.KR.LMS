...
| TASK-B-077 | 260707 | Issue #256 — REQ-05 아이템 가격 UI 노출 (unit_price + currency) | P3 | 없음 | Baker (구현) | 🔔 | [TASK-B-077](tasks/TASK-B-077_260707_ISS256_REQ05_아이템가격UI노출_Baker.md) | Issue #256 · NestedItems 그리드 재배치 · 코드 `6b85fde` · build PASS · 회귀 489/489 PASS · PR 생성 대기 |
