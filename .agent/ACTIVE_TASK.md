...
| TASK-B-016 | 260622 | CI pr-checks.yml .env.local 파싱 버그 수정 — supabase status --output env + printf | High | — | Jaison | 🔔 | [TASK-B-016](tasks/TASK-B-016_260622_CI_env_fix_Jaison.md) | IMP-131 · Issue #72 · PR#73 |
---
