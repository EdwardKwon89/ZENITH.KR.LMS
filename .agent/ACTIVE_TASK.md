...
| TASK-B-129 | 260715 | Issue #489 관련 — recipient_email 입력창 추가 (OrderRegistrationForm) | P1 | 없음 | Baker (구현) | 🔔 | [TASK-B-129](tasks/TASK-B-129_260715_Iss489_RecipientEmailInput_Baker.md) | 수하인 정보 섹션에 Email ZenInput 추가 · Zod 스키마·DB 컬럼·RPC 전부 이미 지원 · Build PASS · Regression 82/82 PASS (504 tests) · 코드 `594eb262` |
