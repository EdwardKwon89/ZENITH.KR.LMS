...
| TASK-B-095 | 260711 | Issue #334 — Critical Navigation i18n 키 누락 (전 role 네비게이션 파손) | P1 | 없음 | Dave (구현) | 🔔 | [TASK-B-095](tasks/TASK-B-095_260711_Iss334_i18nNavigationFix_Dave.md) | 4개 로케일 Navigation에 agency_ups_rates_nav/shipper_ups_rates_nav 추가 · top-level 중복 정리 · 커밋 `4320d8d0` · build PASS |
