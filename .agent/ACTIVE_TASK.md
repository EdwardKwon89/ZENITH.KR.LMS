...
| TASK-B-133 | 260715 | Issue #514 — order rate snapshot dest_country_code 수정 | P1 | 없음 | Mike (구현) | 🔔 | [TASK-B-133](tasks/TASK-B-133_260715_Iss514_OrderSnapshotCountry_Mike.md) | saveOrderRateSnapshot: dest_port_id 기반 zen_ports 조회 → recipient_country_code 직접 사용 · Build PASS ✅ · Regression 84/84 ALL PASS (520 tests) · PR#516 |
