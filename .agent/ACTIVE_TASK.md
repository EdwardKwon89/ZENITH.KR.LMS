...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#1190](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1190) | [Team B] TASK-B-324: 오더 화주명 수기입력값이 SHXK(UPS) 실제 배송 등록에 미반영 (DEF-B-144) | b | p2 | in-progress | jungjs | 2026-09-13 |
