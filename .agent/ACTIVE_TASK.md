...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#1158](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1158) | [feat] TASK-B-317 — 화주별 일별 청구 집계 오더번호 링크·청구 컬럼 개편 + 청구확정(실제원가) 팝업 | b | p2 | in-progress | jungjs | 2026-08-17 |
