...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#290](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/290) | [feat] 오더 등록 폼 보완 2차 — 패킹UI 2줄배치·필수표시·HSCode확인UX·주소록저장버튼·COUNT자동계산 | b | p2 | in-progress | jungjs | 2026-07-09 |
...
| TASK-B-083 | 260709 | Issue #290 — REQ-09/10 HSCode 확인 UX + 주소록 저장 버튼 | P2 | TASK-B-082 ✅ | Dave (구현) | 🔔 | [TASK-B-083](tasks/TASK-B-083_260709_ISS290_오더등록폼_REQ09_REQ10_Dave.md) | Issue #290 (Dave 할당분 REQ-09/10) · REQ-09 HSCode auto-fill → 확인 UX 전환 · REQ-10 주소록 저장 버튼 추가 · tsc: 기존 오류 외 추가 없음 ·
