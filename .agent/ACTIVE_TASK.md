...
| TASK-B-060 | 260705 | Issue #181 — 오더 등록 화면 estimateUpsFreight 연동 + UPS 견적 UI 표시 | P1 | TASK-B-059 ✅ | Baker (구현) | 🔔 | [TASK-B-060](tasks/TASK-B-060_260705_ISS181_UPS견적UI연동_Baker.md) | Issue #181 · 코드 `<TBD>` · 회귀 489/489 PASS · PR 생성 대기 |
