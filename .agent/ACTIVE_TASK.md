...
| TASK-101 | 260529 | B_Kai 재교육 세션 2차 (R-17 위반 3회 누적) | P4 | 없음 | B_Kai | ⬜ | [TASK-101](tasks/TASK-101_260529_BKai재교육세션2차_BKai.md) | §1 DoD 허위 체크 금지 · §2 재제출 커밋 전체 기재 · §3 완료 보고 5단계 |
...
| B_Kai | TASK-101 ⬜ (재교육 세션 2차) | — | **신규 Task 할당 중단 — TASK-101 완료 후 재개** |
| D_Kai | TASK-100 ❌ 최소 재작업 중 (status ⬜→🔔 단독 커밋) | R-17 위반 누적 경고 (상태 미변경 2회 — TASK-098+TASK-100) | — |
