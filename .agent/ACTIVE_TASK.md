...
| TASK-147 | 260615 | [P7-SPR-02] Agency 대시보드 + NaviSidebar AGENCY 메뉴 추가 — /agency | P1 | TASK-145 ✅ | Dave | ⬜ | [TASK-147](tasks/TASK-147_260615_Agency대시보드NaviSidebar_Gale.md) | IMP-114 · Gale→Dave 재배정 (2026-06-15) · 즉시 착수 가능 |
...
| **Dave** (AI Agent) | ⬜ TASK-147 착수 대기 | TASK-145 🔔 완료 · TASK-147 재배정 — 즉시 착수 가능 |
