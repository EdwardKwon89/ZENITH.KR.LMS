...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#462](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/462) | [fix] 주소록 정보 불완전 저장/불러오기(PCCC·시도·시군구·우편번호) + UPS transport_mode DB 드리프트 | b | p1 | - | 미배정 | 2026-07-14 |
...
| TASK-B-121 | 260713 | Issue #457 (P1) — Shipper 운임 계산 로직 수정 (할인율 기본운임 적용) | P1 | 없음 | Mike (구현) | ✅ | [TASK-B-121](tasks/TASK-B-121_260713_Iss457_ShipperFreightCalc_Mike.md) | computeShipperFreight 시그니처 변경(할인율 기본운임만 적용) · UpsShipperFreightResult 타입 수정 · freight.ts 호출부 수정 · UpsFreightEstimatePanel 부피중량+운임 세부내역 표출 · 테스트 2건 수정 · Build PASS ✅ · Regression 81/81 ALL PASS · PR#460 ✅ Aiden 승인·머지 완료(260714) · Issue #457 Close(260714) |
