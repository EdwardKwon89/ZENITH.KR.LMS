...
| TASK-030 | 260520 | Feature Flags unstable_cache 적용 | P3 | 없음 | D_Kai | ❌ | [TASK-030](tasks/TASK-030_260520_FeatureFlags캐싱_DKai.md) | IMP-020 · R-17 혼합 커밋 · 코드 커밋 해시 미기재 · 문서 커밋 재수행 필요 |
...
| B_Kai | **TASK-029 🔄** (설계 확정 · 즉시 착수) | TASK-036 ❌ (커밋 해시 수정 · 재보고) | — |
| D_Kai | **TASK-029 협업** (복잡 쿼리 시그니처 설계) | TASK-030 ❌ (문서 커밋 재수행) | TASK-031 (TASK-030 완료 후) · TASK-037 (TASK-031 완료 후) |
