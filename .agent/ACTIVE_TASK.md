...
| TASK-B-125 | 260715 | Issue #476 (P1) — UPS 다중 패키지 정산중량 합산 구현 | P1 | 없음 | Mike (구현) | 🔔 | [TASK-B-125](tasks/TASK-B-125_260715_Iss476_MultiPackage_Mike.md) | Zod UPS 1패키지 제약 삭제 · calcMultiPackageChargeableWeight 함수 신설 · UpsFreightEstimateSection packages[0]→전체 배열 · Build PASS ✅ · Regression 81/81 ALL PASS · PR#477 |
