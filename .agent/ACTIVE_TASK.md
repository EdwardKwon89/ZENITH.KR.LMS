...
| TASK-148 | 260616 | [P7-SPR-03] 간이 UPS 인보이스 PDF 출력 | P2 | TASK-138 ✅ · TASK-146 ✅ | B_Kai | ❌ | [TASK-148](tasks/TASK-148_260616_P7SPR03_UPS인보이스PDF_BKai.md) | IMP-117 · ❌ 반려(5차) — DoD 해시 `0f4e72b`는 B_Kai 브랜치에 없음(Riley 브랜치 병렬 커밋). 실제 4파일 커밋 `8b4dded`로 갱신 필요 |
| TASK-149 | 260616 | [P7-SPR-04] 오더 등록 직접배송/픽업 선택 UI | P1 | TASK-138 ✅ | Riley | ❌ | [TASK-149](tasks/TASK-149_260616_P7SPR04_오더직접배송픽업UI_Riley.md) | IMP-118 · ❌ 반려(3차) — DoD hash `8a99b92` 고아 커밋 + 헤더 ❌ 미변경 (실제 4파일 커밋 `e38c873`으로 갱신 필요) |
...
| **Riley** | ❌ TASK-149 반려(3차) — 재작업 필요 | DoD 문서 커밋 해시 불일치(`3dff29b1`→`e38c873`) + task file 헤더 ❌ 미변경 |
