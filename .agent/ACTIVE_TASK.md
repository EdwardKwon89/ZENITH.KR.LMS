...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#404](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/404) | [fix] Critical — 오더등록 Shipment Summary 중량/부피 계산에 packing_count 곱셈 잔존 (Issue #294 재발) | b | p1 | - | 미배정 | 2026-07-12 |
| [#403](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/403) | [fix] Critical — UPS Zone 조회 시 국가코드 자릿수 불일치(2자리 vs 3자리)로 Zone 매칭 실패 | b | p1 | review | 미배정 | 2026-07-12 |
...
| TASK-B-111 | 260712 | Issue #404 — totals useMemo packing_count 곱셈 제거 | P2 | 없음 | Mike (구현) | 🔔 | [TASK-B-111](tasks/TASK-B-111_260712_Iss404_TotalsPackingCount_Mike.md) | OrderRegistrationForm.tsx totals useMemo에서 packing_count 곱셈 제거 · Build PASS ✅ · Regression 81/81 ALL PASS · PR#406 |
| TASK-B-111 | 260712 | Issue #403 — UPS Zone 국가코드 alpha-3→alpha-2 마이그레이션 | P1 | 없음 | Dave (구현) | 🔔 | [TASK-B-111](tasks/TASK-B-111_260712_iss403_zone_country_code_alpha2_Dave.md) | zen_ups_zone_countries.country_code 46행 alpha-3→alpha-2 변환 (CASE문) · 시드 데이터 alpha-2 일관성 수정 · 실제 CI PASS(headSha 일치 확인) · PR#407 |
