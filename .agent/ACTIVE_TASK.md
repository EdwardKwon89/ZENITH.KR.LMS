...
| [#294](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/294) | [design] zen_order_packages.packing_count 의미 불일치 — 물리적 박스 수 vs 품목 개수 (실 배송라벨/인보이스 영향) | b | p1 | review | jungjs | 2026-07-11 |
...
| TASK-B-101 | 260711 | Issue #294 — packing_count 의미 불일치 (physical_box_count 기반 작업) | P1 | 없음 | Dave (구현) | 🔔 | [TASK-B-101](tasks/TASK-B-101_260711_Iss294_physicalBoxCount_Dave.md) | physical_box_count 컬럼 추가 · routing/orders/tisa 계산식 수정 · 참조 전환 · UPS Zod refine · CI PASS ✅ · PR#357 |
