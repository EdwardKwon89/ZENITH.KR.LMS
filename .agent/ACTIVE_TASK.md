...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#337](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/337) | [fix] Critical — proxy.ts 미들웨어 org_type 게이트가 /shipper·/agency 차단 (RBAC 수정과 별개) | b | p1 | - | 미배정 | 2026-07-11 |
| [#334](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/334) | [fix] Critical — Navigation i18n 키 누락으로 전체 대시보드 네비게이션 파손 (전 role 영향) | b | p1 | review | 미배정 | 2026-07-11 |
...
| TASK-B-096 | 260711 | Issue #334 — Critical Navigation i18n 키 누락 (전 role 네비게이션 파손) | P1 | 없음 | Dave (구현) | 🔔 | [TASK-B-096](tasks/TASK-B-096_260711_Iss334_i18nNavigationFix_Dave.md) | 4개 로케일 Navigation에 agency_ups_rates_nav/shipper_ups_rates_nav 추가 · top-level 중복 정리 · 커밋 `4320d8d0` · build PASS |
