...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#294](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/294) | [design] zen_order_packages.packing_count 의미 불일치 — 물리적 박스 수 vs 품목 개수 (실 배송라벨/인보이스 영향) | b | p1 | open | jungjs | 2026-07-09 |
