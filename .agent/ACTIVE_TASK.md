...
| TASK-013 | 260516 | Signup race condition 수정 | P3 | 없음 | Ring | 🔔 | [TASK-013](tasks/TASK-013_260516_SignupRaceCondition수정_Ring.md) | IMP-068 중복선언 버그 수정(56a8fa1) · 209/209 PASS · 4차 재제출 |
...
| B_Kai | — | 전량 완료 |
| D_Kai | — | 전량 완료 |
| Ring | TASK-013 ❌ 재제출 (4차·중복선언 버그 수정 56a8fa1) | — (TASK-014 ✅ 완료) |
