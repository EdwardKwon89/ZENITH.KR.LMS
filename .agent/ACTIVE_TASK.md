...
| TASK-111 | 260604 | Route Network 자동 생성 + DEF-040 해소 | P1 | 없음 | Noah (Codex) | 🔔 | [TASK-111](tasks/TASK-111_260604_UAT02RouteOptimizationSeed_DKai.md) | `ea1c5cb` + rates.ts autoCreateRouteNetwork · ICN→JFK 시드 + Rate 등록 시 route network 자동 upsert · DEF-040 수정완료 · 236/236 ✅ |
...
| B_Kai | — | — | — |
| D_Kai (OpenCode) | — | R-17 v1.5 위반 누적 — 보완 커밋 반복 경향 (TASK-110, Advisory) | — |
