...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#391](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/391) | [feat] UPS 할인율/부피중량 기준값 적용일자·종료일자 설정 + 변경 이력 관리 | b | p1 | - | 미배정 | 2026-07-12 |
...
| TASK-B-109 | 260712 | Issue #391 (3단계) — UPS 요금 스케줄링 Vercel Cron 배치 (매일 자정) | P1 | 없음 | Mike (구현) | 🔔 | [TASK-B-109](tasks/TASK-B-109_260712_Iss391_PricingScheduleCron_Mike.md) | vercel.json cron 설정 · /api/cron/pricing-schedule-apply 신규 · 적용(SCHEDULED→APPLIED) + 만료(EXPIRE) 배치 · Vercel Cron 인증 · Build PASS ✅ · Regression 78/81 PASS · PR#397 |
