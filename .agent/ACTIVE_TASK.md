...
| TASK-B-113 | 260713 | Issue #414 — 조직 소속 사용자 주소록 RLS 정책 재생성 | P1 | 없음 | Dave (구현) | 🔔 | [TASK-B-113](tasks/TASK-B-113_260713_iss414_address_book_rls_Dave.md) | zen_address_book_org_member_access org_id JWT 패턴 재생성 (USING+WITH CHECK) · 실제 CI PASS(headSha 일치 확인) · PR#416 |
