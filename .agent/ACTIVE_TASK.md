...
| TASK-B-136 | 260716 | Issue #523 — SHIPPER 역할 RLS 정책 추가 | P1 | 없음 | Mike (구현) | 🔔 | [TASK-B-136](tasks/TASK-B-136_260716_Iss523_ShipperRLS_Mike.md) | zen_agency_shipper_zone_discounts SHIPPER/AGENCY_SHIPPER SELECT 허용 RLS 정책 · Build PASS ✅ · Regression 85/85 ALL PASS (534 tests) · PR#524 |
