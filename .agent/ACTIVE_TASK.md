...
| TASK-B-076 | 260707 | Issue #258 — REQ-03/04 패키지 content_type(GENERAL/DOC/NONDOC) + 지역운송장번호 | P2 | TASK-B-077 ✅ | Baker (구현) | 🔔 | [TASK-B-076](tasks/TASK-B-076_260707_ISS258_REQ03_REQ04_패키지content_type_지역운송장번호_Baker.md) | Issue #258 · DB/RPC/UI/Schema · 코드 `ffaaffa` · 문서 `0b395cc` · build PASS · 회귀 489/489 PASS · PR#263 |
