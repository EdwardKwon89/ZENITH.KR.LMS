...
| TASK-B-120 | 260714 | Issue #455 — get_next_order_sequence RBAC에 AGENCY/AGENCY_SHIPPER 추가 (Critical) | P1 | 없음 | Baker (구현) | 🔄 | [TASK-B-120](tasks/TASK-B-120_260714_Iss455_SequenceRbac_Baker.md) | get_next_order_sequence 함수 NOT IN 목록에 AGENCY, AGENCY_SHIPPER 추가 · Build PASS · Regression 485/485 ALL PASS · get_my_role() 사용처 8건 전수조사 완료(나머지 7건은 관리자 전용) |
