...
| TASK-143 | 260614 | [P7-SPR-02] UPS 요율 조회 Server Actions 5종 (`rates.ts` — Zone/Product/BaseRate/Fuel/OC) | P1 | TASK-138 ✅ | D_Kai | 🔔 | [TASK-143](tasks/TASK-143_260614_UPS_조회ServerActions_DKai.md) | IMP-112 일부 · c0ec743 · 재작업 완료: DoD 보완 + 빌드 PASS ✅ + LIVE_MAP 등재 |
| TASK-144 | 260614 | [P7-SPR-02] 창고 입고 화면 REF_NO 입력 UI (domestic_ref_no / intl_ref_no + locked 처리) | P1 | TASK-138 ✅ | B_Kai | ⬜ | [TASK-144](tasks/TASK-144_260614_창고입고REF_NO_UI_BKai.md) | IMP-112 일부 · TASK-141 병행 |
...
| **D_Kai (OpenCode)** | 🔔 TASK-143 재작업 완료 — DoD 보완 + 빌드 PASS ✅ | IMP-112 일부 — rates.ts 5종 조회 Server Actions
| **B_Kai** | ⬜ TASK-144 착수 대기 | IMP-112 일부 — 창고 입고 REF_NO UI (독립 브랜치) |
