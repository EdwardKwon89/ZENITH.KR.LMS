...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#1135](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1135) | TASK-B-306: UPS 상세 배송기본정보 카드 — 화주/수령인 주소에 city/state/zipcode/country 추가 (DEF-B-135) | b | p2 | - | 미배정 | 2026-08-16 |
