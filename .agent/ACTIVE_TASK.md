...
| TASK-B-114 | 260713 | Issue #417 — UPS Direct 오더 등록 무한 루프 크래시 수정 (Critical) | P1 | 없음 | Mike (구현) | 🔔 | [TASK-B-114](tasks/TASK-B-114_260713_Iss417_UpsInfiniteLoop_Mike.md) | UpsFreightEstimateSection.tsx useEffect 의존성 packages→원시값 교체 · totalWeight/firstPkgDim useMemo 추가 · 무한 루프 해소 · Build PASS ✅ · Regression 81/81 ALL PASS · e2e 테스트 DOC/NON_DOC ALL PASS · PR#422 |
| TASK-B-115 | 260713 | Issue #421 — 주소록 org_id 기반 RLS 회귀 테스트 보강 | P3 | 없음 | Dave (구현) | 🔔 | [TASK-B-115](tasks/TASK-B-115_260713_iss421_address_rls_e2e_Dave.md) | e2e-21 org_id AGENCY_SHIPPER 시나리오 추가 · LIVE_REGRESSION_TEST_MAP TC-P7-ADDR-06 추가 · PR#423 |
