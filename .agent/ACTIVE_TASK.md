...
| TASK-B-152 | 260717 | Issue #559 — 무역서류 관리 UPS 문서 조회/취소 버튼 | P2 | 없음 | Dave (구현) | ✅ | [TASK-B-152](tasks/TASK-B-152_260717_iss559_trade_documents_Dave.md) | fetchShxkTradeDocument+getUpsLabelStatus · UpsTradeDocumentActions 컴포넌트 · isUpsOrder DEF-101 수정 · 실제 CI PASS(headSha `5a525ca6`) · PR#561 · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-153 | 260717 | Issue #563 — placeShxkOrder 화주 영문 주소 우선 매핑 | P2 | 없음 | Mike (구현) | ✅ | [TASK-B-153](tasks/TASK-B-153_260717_Iss563_ShipperAddressEnglish_Mike.md) | lookupOrderPackages shipper_org 조인 · placeShxkOrder shipperStreet 영문우선(조직영문→조직한글→오더스냅샷) · 회귀 테스트 5건 · Build PASS · Regression 94/94 ALL PASS (580 tests) · PR#564 · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-154 | 260717 | Issue #565 — 무역서류 관리 createorder 버튼 + JSON 확인 팝업 | P2 | 없음 | Dave (구현) | ✅ | [TASK-B-154](tasks/TASK-B-154_260717_Issue565_UpsTradeDocumentPreviewPopup_Dave.md) | buildCreateOrderPayload 순수 함수 추출 · previewShxkPayload+triggerCreateOrderTest 신설 · 5개 버튼 전부 JSON 미리보기 팝업 게이트 · 단위테스트 12종(121/121) · **⚠️ feature 브랜치 없이 integration/teamb-260716에 직접 push됨(PR 리뷰 생략) — Jaison 사후 검증(전체 회귀 594/594 독립 재실행 + 네거티브 컨트롤) 완료, 코드 자체는 정확하나 절차 위반** · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-155 | 260717 | Issue #567 — DEF-102 CSP connect-src data: 추가 | P1 | 없음 | Baker (구현) | ✅ | [TASK-B-155](tasks/TASK-B-155_260717_DEF102_CSPConnectSrc_Baker.md) | next.config.ts connect-src에 data: 추가 · 회귀 95/95 ALL PASS (594 tests) · PR#568 · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-156 | 260717 | Issue #569 — createorder 버튼 issueUpsLabel 연결 | P2 | TASK-B-154 ✅ | Dave (구현) | ✅ | [TASK-B-156](tasks/TASK-B-156_260717_Iss569_CreateorderIssueUpsLabel_Dave.md) | import triggerCreateOrderTest→issueUpsLabel 교체 · handleConfirmPreview CREATEORDER issueUpsLabel 호출+router.refresh · 테스트 갱신 · PR#570 · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-157 | 260717 | Issue #571 — DEF-103 AddressInput KR분기 재설계 (드롭다운+ISO코드+shipper_province) | P1 | 없음 | Baker (구현) | ✅ | [TASK-B-157](tasks/TASK-B-157_260717_DEF103_AddressInputStateCity_Baker.md) | useEffect KR가드 제거 · onComplete KR_SIDO_TO_ISOCODE+City 매칭 · KR 드롭다운 UI · label-mapping shipper_province 변환 · 95/95 ALL PASS 601 tests · PR#572 · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-158 | 260717 | Issue #573 — DEF-104 SHXK invoice unit_code 매핑 + MTR 옵션 추가 | P1 | 없음 | Mike (구현) | ✅ | [TASK-B-158](tasks/TASK-B-158_260717_Iss573_ShxkUnitCode_Mike.md) | resolveShxkUnitCode 함수(EA/PCS→PCE, SET→SET, MTR→MTR) · buildInvoiceFromItems unit_code 추가 · OrderRegistrationForm MTR 옵션 · 테스트 10건 · 95/95 ALL PASS 610 tests · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-159 | 260717 | Issue #574 — DEF-105 오더 품명 영문 전용 입력 제한 | P2 | 없음 | Dave (구현) | ✅ | [TASK-B-159](tasks/TASK-B-159_260717_Def105_ItemNameEnglishOnly_Dave.md) | orderItemSchema regex 영문 전용 · OrderRegistrationForm 에러 메시지 표시 · 테스트 5종 · 95/95 ALL PASS 615 tests · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-160 | 260717 | Issue #577 — DEF-106 SHXK province 풀네임→코드값 되돌림 (Sold To 길이제약) | P1 | 없음 | Dave (구현) | ✅ | [TASK-B-160](tasks/TASK-B-160_260717_Def106_ProvinceCodeRevert_Dave.md) | buildCreateOrderPayload shipper/consignee province 원본코드 사용 · resolveProvinceEnglishName 제거 · 테스트 2건 신규+8건 삭제+1건 수정 · 95/95 ALL PASS 609 tests · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-161 | 260717 | Issue #580 — DEF-107 SHXK cargovolume child_number 하이픈 제거 (Package Reference 거부) | P1 | 없음 | Dave (구현) | ✅ | [TASK-B-161](tasks/TASK-B-161_260717_Def107_ChildNumberHyphenStrip_Dave.md) | buildCargovolume child_number `.replace(/-/g, '')` · 기존 테스트 기대값 수정+실제 UUID 검증 1건 신규 · 95/95 ALL PASS 610 tests · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-162 | 260717 | Issue #582 — fetchShxkTradeDocument 응답 결과 팝업 | P3 | 없음 | Mike (구현) | ✅ | [TASK-B-162](tasks/TASK-B-162_260717_Iss582_TradeDocResultPopup_Mike.md) | ResultPopup 컴포넌트 신규 · resultState 추가 · handleConfirmPreview window.open 제거 · 테스트 5건 · 95/95 ALL PASS 615 tests · **develop 병합 완료(PR#584, 260718) — Aiden 승인** 
| TASK-B-163 | 260718 | Issue #586 — DEF-108 SHXK getnewlabel/removeorder reference_no 하이픈 제거 | P1 | 없음 | Baker (구현) | ✅ | [TASK-B-163](tasks/TASK-B-163_260718_Def108_RefNoHyphenStrip_Baker.md) | DEF-108 해소 · ups-labels.ts 5곳 수정 · getnewlabel/removeorder/previewShxkPayload · 회귀 95/95 ALL PASS 620 tests · [PR#595](https://github.com/EdwardKwon89/ZENITH.KR.LMS/pull/595) (base: TeamB_Dev) · **develop 병합 완료(PR#601, 260719) — Aiden 승인** 
| TASK-B-164 | 260718 | Issue #587 — 오더 수정 페이지 신설 + updateOrder 필드 보완 (DEF-109) | P1 | 없음 | Dave (구현) | ✅ | [TASK-B-164](tasks/TASK-B-164_DEF109_오더수정페이지.md) | 코드 `187c67ff`+`c520183c` · updateOrder 14개 필드 보완 · edit/page.tsx 신규 · OrderRegistrationForm edit 모드 지원 · 오더 상세 "Edit" 버튼 추가 · 619/619 ALL PASS · CI ✅ · **TeamB_Dev 병합 완료(PR#593, 260718) — Jaison 승인, develop 배치병합·최종 ✅는 Aiden 대기** · **develop 병합 완료(PR#601, 260719) — Aiden 승인** 
| TASK-B-165 | 260718 | Issue #590 — 화주(Shipper) 급증 수수료(Surge Fee) 조회 탭 추가 | P2 | 없음 | Mike (구현) | ✅ | [TASK-B-165](tasks/TASK-B-165_260718_Iss590_ShipperSurgeFeeTab_Mike.md) | 코드 `ab2e1264` · 626/626 ALL PASS · PR 생성 대기 · **develop 병합 완료(PR#601, 260719) — Aiden 승인** 
| TASK-B-166 | 260718 | Issue #597 — DEF-110 createorder reference_no 하이픈 제거 | P1 | 없음 | Baker (구현) | ✅ | [TASK-B-166](tasks/TASK-B-166_260718_Def110_CreateOrderRefNoHyphenStrip_Baker.md) | DEF-110 해소 · label-mapping.ts 1곳 수정 · buildCreateOrderPayload reference_no · 회귀 97/97 ALL PASS 629 tests · PR 대기 · **develop 병합 완료(PR#601, 260719) — Aiden 승인** 
...
| TASK-188 | 260720 | [Team A] Agency 정산 화면 권한 공백 수정 — Issue #603 §A+§B | 없음 | Riley (D_Kai에서 재배정) | 🔄 | [TASK-188](tasks/TASK-188_260720_Issue603_Agency정산화면권한공백_DKai.md) | Aiden 반려(260720, 실제 CI FAILURE — tsc 오류: `OrderFinanceSummaryProps`에 `canAddManualCost` 미선언) 후, D_Kai(OpenCode) 무응답으로 Riley에게 재배정(260720). 기존 브랜치·PR#611 유지, 재작업 커밋만 `[Riley]` 태그로 추가 |
...
| **D_Kai (OpenCode)** | ⚠️ 무응답 (260720) | TASK-188 §A CI FAILURE 반려 후 재작업 지시 시점에 정상 응답 불가 확인(Edward 보고) — TASK-188 재작업은 Riley로 재배정. TASK-189(Issue #607)는 D_Kai 응답 재개 시 재확인 필요. 이전: TASK-182 ✅ 완료(R-17 위반 2회) — 기준요금 매트릭스 UI, 3회 시 할당 중단 대상 유의 |
| **B_Kai** | ✅ GH#206 승인·머지 완료 (260706) | PR#221 · #13 재조사 요청에 신속·정확 대응(docs/03_Design 17개 파일 아카이브), 신규 Task 대기 |
| **Riley** | ✅ TASK-187 승인·머지 완료 (260720) | PR#610 머지 완료(Issue #606 Close). **TASK-188 재작업 신규 배정(260720)** — D_Kai 무응답으로 Issue #603 §A CI FAILURE 재작업 인수(기존 브랜치·PR#611 유지, `[Riley]` 태그로 커밋). 이전: TASK-186 승인·머지 완료(PR#608, 260720), 이전 R-17 §0 위반(TASK-185) 이후 절차 준수 확인 |
