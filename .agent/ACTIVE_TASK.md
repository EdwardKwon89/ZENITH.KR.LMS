...
| TASK-B-094 | 260711 | Issue #325 — 화주 Zone 할인율 폴백 제거 (globalDiscountRate) | P2 | TASK-B-093 ✅ | Dave (구현) | 🔔 | [TASK-B-094](tasks/TASK-B-094_260711_Iss325_ZoneDiscountFallback_Dave.md) | getDiscountRate 폴백 globalDiscountRate→0 · page.tsx zen_agency_shippers.discount_rate 조회 제거 · 커밋 `b8fb1670` · build PASS · 🔔 검토 대기 |
