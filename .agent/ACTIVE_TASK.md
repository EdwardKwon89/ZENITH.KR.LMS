...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#285](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/285) | [fix] 신규운송요청 탭 전환 시 화주/수하인 입력값 초기화 버그 | b | p2 | - | jungjs | 2026-07-08 |
...
| TASK-B-081 | 260708 | Issue #285 — 탭 전환 시 화주/수하인 입력값 초기화 버그 | P2 | 없음 | Dave (구현) | 🔔 | [TASK-B-081](tasks/TASK-B-081_260708_ISS285_탭전환입력값초기화_Dave.md) | Issue #285 · 코드 `4082c6ba` · build PASS · 회귀 489/489 PASS |
