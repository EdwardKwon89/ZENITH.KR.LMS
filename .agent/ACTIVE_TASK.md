...
| TASK-144 | 260614 | [P7-SPR-02] 창고 입고 화면 REF_NO 입력 UI (domestic_ref_no / intl_ref_no + locked 처리) | P1 | TASK-138 ✅ | B_Kai | 🔔 | [TASK-144](tasks/TASK-144_260614_창고입고REF_NO_UI_BKai.md) | IMP-112 일부 · b315d49+6870271 · TC-WH-REF 4/4 PASS · 351/357 회귀 · 재작업 후 재제출 |
...
| **D_Kai (OpenCode)** | 🔔 TASK-143 재작업 2차 완료 — DoD item 7·8 보완 + 해시 정정 ✅ | IMP-112 일부 — rates.ts 5종 조회 Server Actions
| **B_Kai** | 🔔 TASK-144 재작업 완료 — 커밋 해시 정정 + TC-WH-REF mock chain 수정 + 전체 회귀 실행 | IMP-112 일부 — 창고 입고 REF_NO UI
