...
| TASK-089 | 260525 | 개인정보 활용동의 체크박스 (회원가입 Wizard) | P1 | 없음 | D_Kai | ❌ | [TASK-089](tasks/TASK-089_260525_개인정보활용동의_DKai.md) | 5a21467+1711d6b · 220/220 · 반려: 문서 커밋 해시 미기재 → 최소 재작업 지시 |
| TASK-090 | 260525 | Rate Limiting 도입 (IMP-046 재활성화) | P1 | 없음 | Riley | 🔄 | [TASK-090](tasks/TASK-090_260525_RateLimiting도입_Riley.md) | IMP-046 · 설계 확정 ✅ (하이브리드 DB+InMemory·10/100회 한도) · 즉시 착수 |
...
|:------|:--------|:----------------|:----------|
| Riley | TASK-090 🔄 (Rate Limiting — 즉시 착수) | — | TASK-092 🚫 (TASK-088 완료 후) |
| B_Kai | TASK-088 🔄 (Hub 경로 탐색 — 즉시 착수) | — | TASK-093 🚫 · TASK-095 🚫 |
| D_Kai | — | TASK-089 ❌ (문서 커밋 해시 미기재 재작업) | TASK-091 🚫 · TASK-094 🚫 |
