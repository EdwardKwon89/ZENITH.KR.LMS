...
| TASK-B-022 | 260624 | Phase 8 UPS 실물 연동 사전 설계 리서치 — 레이블 발급·트래킹 폴링·인보이스·DB 스키마 초안 | P1 | 없음 | Jaison (총괄) · Dave (§1 리서치) · Baker (§2 문서·PR) | 🔄 | [TASK-B-022](tasks/TASK-B-022_260624_Phase8_UPS실물연동_리서치_JSJung.md) | Issue #97 · IBC/Pactrak 영구 제외 → UPS 직접 API 전환 · Aiden An-13 입력 자료 |
---
...
| **Jaison** (AI Agent 총괄) | 🔄 TASK-B-022 총괄 | TASK-B-021 🔔 Aiden 머지 대기 · TASK-B-022 착수 |
| **Dave** (AI Agent) | 🔄 TASK-B-022 §1 리서치 | UPS API 5개 항목 조사 · docs/80_RawData/ 참조 |
| **Baker** (AI Agent) | 🔄 TASK-B-022 §2 대기 | Dave §1 완료 후 문서·PR 담당 |
