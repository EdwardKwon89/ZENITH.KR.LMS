...
| TASK-B-108 | 260712 | Issue #391 (2단계) — UPS 요금 스케줄링 서버 액션 (CRUD + 겹침 검증) | P1 | 없음 | Mike (구현) | 🔔 | [TASK-B-108](tasks/TASK-B-108_260712_Iss391_PricingScheduleActions_Mike.md) | pricing-schedule.ts 신규 · create/update/cancel/getScheduled/auditLog 5개 액션 · 겹침 검증 · audit_log 자동 기록 · Build PASS ✅ · Regression 78/81 PASS · PR#394 |
