...
| TASK-B-141 | 260716 | Issue #534 — UPS 급증 수수료 국가코드 alpha-3→alpha-2 통일 | P1 | 없음 | Baker (구현) | 🔔 | [TASK-B-141](tasks/TASK-B-141_260716_Iss534_SurgeFeeAlpha2_Baker.md) | zen_ups_surge_fees 30행 alpha-3→alpha-2 UPDATE · SurgeFeeForm 라벨/placeholder/slice 갱신 · alpha-2 매칭 테스트 4건 · Build PASS · Regression 86/86 PASS (534 tests) · 코드 `23b74bba` · PR#535 반려→재제출 예정 |
