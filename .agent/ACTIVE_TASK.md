...
| TASK-141 | 260614 | [P7-SPR-02] UPS 요금 계산 엔진 코어 (`pricing-engine.ts` + 타입 + `pricing.ts` 래퍼 + TC) | P1 | TASK-138 ✅ | Aiden | 🔔 | [TASK-141](tasks/TASK-141_260614_Phase7UPS_요금계산엔진_창고입고수정_Aiden.md) | IMP-112 코어 · `e60fff0` · TC-UPS-P 12/12 ✅ |
...
| **B_Kai** | ⬜ 🔄 TASK-144 착수 — IMP-112 창고 입고 REF_NO UI
