...
| # | 제목 | 팀 | 우선순위 | 상태 | 담당 | 갱신일 |
|:-:|:-----|:--:|:-------:|:----|:-----|:-------|
| [#1194](https://github.com/EdwardKwon89/ZENITH.KR.LMS/issues/1194) | [Team B] TASK-B-326: SHXK shipper_street 시/구/도 포함 시 UPS AddressLine 초과로 등록 거부 (DEF-B-146, High) — DEF-B-145 후속 | b | p1 | review | jungjs | 2026-09-13 |
