...
- 테스트 커버리지: 12건 추가 (agency-warehouse-scoping.test.ts)
  - AGENCY 403 테스트 (OPERATOR/SHIPPER/INDIVIDUAL角色)
  - AGENCY 스코핑 (소속 화주 오더만 조회, 비소속 차단)
  - confirmOutbound (소속 성공 + 비소속 차단)
  - getTodayReleasedOrders (소속 화주 필터링)
  - AGENCY_SHIPPER角色 403, MANAGER角色 스코핑 없음
  - zen_agency_shippers 조회 실패 시 빈 목록 반환
