...
- [ ] `docs/91_FinalTest/UAT/UAT_05_정산_인보이스.md` 작성 완료 (5개 시나리오, 템플릿 준수)
- [ ] `docs/91_FinalTest/UAT/UAT_06_추적_스케줄.md` 작성 완료 (3개 시나리오, 템플릿 준수)
- [ ] `UAT_MASTER.md` 인덱스 UAT-05·06 상태 ✅ + 담당 B_Kai 반영
- [ ] 코드 커밋 완료 (해시 기재)
