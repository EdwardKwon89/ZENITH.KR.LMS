...
- [ ] `tests/e2e/e2e-14-returned-flow.spec.ts` 작성 완료
- [ ] 케이스 A (RETURNED→WAREHOUSED) E2E PASS — 스크린샷 증적
- [ ] 케이스 B (RETURNED→DISPOSED) E2E PASS — 스크린샷 증적
- [ ] StatusChangeModal 전이 옵션 3종(WAREHOUSED·CANCELED·DISPOSED) 표시 확인
- [ ] `docs/99_Manual/E2E_SCENARIOS.md` E2E-14 항목 추가 (요약표 + 상세 정의)
- [ ] 회귀 테스트 전체 PASS 증적 (`docs/08_Self_Audit/Regression_Results/`)
- [ ] `[B_Kai] test: E2E-14` 코드 커밋 완료 (해시 기재)
- [ ] `[B_Kai] docs: TASK-053` 문서 커밋 완료 (해시 기재)
