...
파일: `supabase/migrations/20260708_ord_001_pkg_content_type.sql`
...
파일: `supabase/migrations/20260708_rpc_create_order_atomic_v4.sql`
...
git checkout -b feature/teamb-task-b076-iss258
```
...
### 수정 내용
1. **DB 마이그레이션** (`supabase/migrations/20260708_ord_001_pkg_content_type.sql`)
   - `zen_order_packages.content_type` 컬럼 추가 (GENERAL/DOC/NONDOC CHECK, DEFAULT 'GENERAL')

2. **RPC 마이그레이션** (`supabase/migrations/20260708_rpc_create_order_atomic_v4.sql`)
