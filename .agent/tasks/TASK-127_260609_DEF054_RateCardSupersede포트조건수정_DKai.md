...
- 코드 커밋 `0183c4e` — `admin.repository.ts:297-319` + `rates.ts:116-124` 수정 확인
- 회귀 316/316 PASS 확인
- IMP-109 `scratch/post_launch_improvements.md` 등록 확인
- R-17 준수 — 코드 커밋 선행·문서 커밋 분리 확인
- Advisory: 태스크 파일 헤더 `상태: ⬜` 미변경 (Aiden 직접 ✅ 갱신)
