...
- [ ] `tests/e2e/e2e-15-dissolve-atomicity.spec.ts` 작성 완료
- [ ] dissolve 후 마스터 오더 삭제 UI 확인 PASS
- [ ] 하우스 오더 마스터 참조 해제 확인 PASS
- [ ] 스크린샷 증적 `docs/99_Manual/E2E_15_Result/` 저장
- [ ] UI 경로 미확인 시 대체 검증 방식 명시
