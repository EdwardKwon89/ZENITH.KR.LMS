...
- [x] `docs/99_Manual/E2E_SCENARIOS.md` E2E-15 항목 API 레벨 검증 방식으로 갱신
...
- `src/components/orders/StatusChangeModal.tsx` createPortal 도입 + 스크롤 영역 추가 (`931a396`)
- `src/components/orders/OrderDataTable.tsx` `isModalOpen` 조건부 z-index 추가 (`931a396`)
- `docs/99_Manual/E2E_SCENARIOS.md` E2E-15 API 레벨 검증 방식으로 갱신 (`931a396`)
- `scratch/20260522000100_fix_zen_orders_updated_at.sql` 불필요 migration 이동 (`931a396`)

> ⚠️ Aiden `c24c8e5` 기수정 "use server" 3건은 D_Kai 성과 아님 — 본 보고에서 제외
