...
- [ ] UAT-01-01 전면 재작성 (다단계 wizard 법인 신규 등록 플로우, DOCS 단계 포함)
- [ ] UAT-01-06 신규 작성 (개인회원 가입, 즉시 /orders 이동 검증)
- [ ] UAT-01-07 신규 작성 (법인 기존 합류 JOIN, 조직 검색·선택 포함)
- [ ] UAT-07-06 신규 작성 (ADMIN VOC 접수 제한 검증)
- [ ] UAT-08-06 신규 작성 (ADMIN customs·corporate 접근 차단, A·B 시나리오 포함)
- [ ] UAT-09-09 신규 작성 (REJECTED 사용자 로그인 차단)
- [ ] UAT-09-10 신규 작성 (자기 자신 역할 변경 제한)
- [ ] UAT_MASTER.md 인덱스 6개 행 추가 + UAT-01-01 비고 갱신 + 총계 56개 갱신
- [ ] 코드 변경 없음 확인
- [ ] 코드 커밋 완료 (해시 기재)
