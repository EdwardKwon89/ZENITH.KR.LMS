...
- 코드: `fee7bf1` `[D_Kai] feat: TASK-143 IMP-112 UPS 요율 조회 Server Actions 5종` (main 브랜치 cherry-pick)
...
- TC-UPS-R-01~05: 5/5 ✅
- LIVE_REGRESSION_TEST_MAP: `cffef80` 커밋에서 TC-UPS-R-01~05 등재 완료 ✅

**R-17 준수**: 준수 (코드 `fee7bf1` → 문서 `cffef80` → 보완 `c97b504` 순서)

**Advisory** (비차단):
- `[Aiden 검토]` 섹션 이전 반려 이력 잔존 — 승인으로 갱신됨
