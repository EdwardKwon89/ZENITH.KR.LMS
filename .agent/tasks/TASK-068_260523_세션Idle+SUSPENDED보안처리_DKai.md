...
- [ ] proxy.ts idle timeout guard 구현 (30분, `zen_last_activity` 쿠키)
- [ ] SUSPENDED 상태 감지 및 `/suspended` redirect 구현
- [ ] `/suspended` 안내 페이지 신규 생성 (로그아웃 버튼 포함)
- [ ] 회귀 테스트 전체 PASS
- [ ] 코드 커밋 완료 (해시 기재)
- [ ] 본 파일 상태 🔔 + ACTIVE_TASK.md 동기화
- [ ] IMP_PROGRESS.md IMP-071·072 🔔 갱신
- [ ] 문서 커밋 완료 (해시 기재)
