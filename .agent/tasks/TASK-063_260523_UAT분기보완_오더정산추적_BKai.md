...
- [ ] UAT-02-08 시나리오 작성 (역할별 상태 변경 권한, 절차 표 포함)
- [ ] UAT-03-04 시나리오 작성 (MASTERED 수정 불가, 절차 표 포함)
- [ ] UAT-05-06 시나리오 작성 (인보이스 상세 링크, 절차 표 포함)
- [ ] UAT-05-07 시나리오 작성 (SHIPPER Settlement 접근, A·B 시나리오 모두 포함)
- [ ] UAT-06-04 시나리오 작성 (SHIPPER vs ADMIN 추적 범위, A·B 시나리오 모두 포함)
- [ ] UAT_MASTER.md 인덱스 5개 행 추가 + 총계 50개 갱신
- [ ] 코드 변경 없음 확인
- [ ] 코드 커밋 완료 (해시 기재)
