...
| **FIX-MCM-001** | — | `105_MODEL_CAPABILITY_MATRIX.md` 오류 수정 (블로커 2 + 경고 3) | 2026-05-13 | 🆕 **착수 가능** |
...
| **FIX-MCM-001** | D_Kai | `105_MODEL_CAPABILITY_MATRIX.md` 오류 수정 | 🆕 착수 가능 | — |
...
**범위**: 모델 프로필 헤더, 비교 테이블 모든 행, 개정 이력 포함 전체 `Opus 4.5` 문자열 일괄 교체.
...
- [ ] [MCM-F1] `Opus 4.5` → `Opus 4.7` 전체 교체 (`grep -c "Opus 4.5"` → 0)
- [ ] [MCM-F2] Sonnet 4.6 헤더 `CTO`로 수정
- [ ] [MCM-F2] 에이전트 매핑 테이블에 CTO 행 추가
- [ ] [MCM-W1] 자기 평가 한계 고지 추가
- [ ] [MCM-W2] Riley 환경 요인 분리 문장 추가
- [ ] [MCM-W3] B_Kai SAR 해설 수정
- [ ] 개정 이력에 v1.3 추가 (작성자: D_Kai, 수정 내용 요약)
- [ ] `git status` 클린 확인
- [ ] 커밋: `[OpenCode] docs: FIX-MCM-001 105 모델 역량 매트릭스 오류 수정 (블로커 2 + 경고 3)`
- [ ] 🔔 Aiden 검토 대기 등록
