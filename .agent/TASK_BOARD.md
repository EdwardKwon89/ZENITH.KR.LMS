...
|:---|:---|:---|:---|
| **FIX-MCM-001** | D_Kai | `105_MODEL_CAPABILITY_MATRIX.md` 오류 수정 (블로커 2 + 경고 3) | 2026-05-13 |
| _(없음 — 모두 검토 완료)_ | — | — | — |
...
| ~~**FIX-MCM-001**~~ | — | `105_MODEL_CAPABILITY_MATRIX.md` 오류 수정 (블로커 2 + 경고 3) | 2026-05-13 | ✅ **완료** |
...
| **FIX-MCM-001** | D_Kai | `105_MODEL_CAPABILITY_MATRIX.md` 오류 수정 | ✅ **Aiden 검토 대기** | — |
