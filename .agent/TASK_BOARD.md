...
> **프로젝트:** ZENITH_LMS
> **업데이트:** 2026-05-13 (KST) — FIX-MCM-001 PASS (v1.3) / FIX-MCM-002 지시 확장 (블로커 3+경미 2) / B_Kai 비활성화 결정
> **운영 원칙:**
...
| **FIX-MCM-002** | — | `105_MODEL_CAPABILITY_MATRIX.md` v1.4 신규 오류 수정 (블로커 3 + 경미 2) | 2026-05-13 | 🆕 **착수 대기** |
...
| **FIX-MCM-002** | D_Kai | `105_MODEL_CAPABILITY_MATRIX.md` v1.4 신규 오류 수정 | 🆕 **D_Kai 착수 대기** | — |
...
- [ ] [MCM2-F1] §22 Big Pickle "해결됨" 문장 → SAR-002 기반 사실 기재로 교체
- [ ] [MCM2-F2] Section 21 오류 원인 귀인 방식 본문 완성 (테이블 + 해설)
- [ ] [MCM2-F3] §22 Ring 2.6 1T SWE-bench `~75%` → `~80.2%` 수정 + 종합 등급 정합성 확인
- [ ] [MCM2-W1] Section 7 섹션 순서 정정 (6 뒤, 8 앞)
- [ ] [MCM2-W2] MiniMax M2.5 "단독 최고" → "Kimi K2.6과 공동 1위" 표현 수정
- [ ] 개정 이력 v1.5 추가
- [ ] `git status` 클린 확인
- [ ] 커밋: `[OpenCode] docs: FIX-MCM-002 105 v1.4 신규 오류 수정 (블로커 3 + 경미 2)`
- [ ] 🔔 Aiden 검토 대기 등록
