...
> **프로젝트:** ZENITH_LMS
> **업데이트:** 2026-05-13 (KST) — FIX-MCM-001 PASS (v1.3) / FIX-MCM-002 신규 지시 / B_Kai 비활성화 결정
> **운영 원칙:**
...
| **FIX-MCM-002** | — | `105_MODEL_CAPABILITY_MATRIX.md` v1.4 신규 오류 수정 (블로커 2 + 경미 1) | 2026-05-13 | 🆕 **착수 대기** |
...
> **수행 주체**: D_Kai (OpenCode) | **검증 주체**: Aiden (Claude) | **우선순위**: Medium
> **대상 파일**: `docs/00_GUIDE/105_MODEL_CAPABILITY_MATRIX.md`
> **근거**: Aiden 검토 — v1.4 자체 추가 작업에서 신규 오류 3건 발생 (2026-05-13)
...
- [ ] 개정 이력 v1.5 추가
- [ ] `git status` 클린 확인
- [ ] 커밋: `[OpenCode] docs: FIX-MCM-002 105 v1.4 신규 오류 수정 (블로커 2 + 경미 1)`
- [ ] 🔔 Aiden 검토 대기 등록
