...
| **합계** | **103** | **107** | **96.3%** | IMP-121 ✅ (260618 Aiden ✅ 승인, PR #29) · IMP-122 ✅ (260617 PR #26 머지) · IMP-120 ✅ (260618 Aiden ✅ 승인, PR #33) · IMP-115 ➖ (Edward 지시) · IMP-117/118/119 ✅ (260617 PR 머지) · IMP-113 ✅ (260616) · IMP-109 ✅ (260616) · IMP-123 🔔 (TASK-161 발령 260619) |
...
| 2026-06-20 | Baker (Big Pickle, Team B) | **IMP-125 🔔 Agency 대시보드 정산 요약 위젯 완료** — TASK-B-009. `AgencySettlementWidget.tsx` 신규(48줄), page.tsx 연동 + 실시간 `orderCount` 반영, i18n 4개국어 5키. TC-B-DASH-01~02 등재. 회귀 212/214 PASS (tracking-business-qa 2건 pre-existing Supabase 미연결). 코드 `d763951`. Jaison 검토 대기 🔔. PR待. |
