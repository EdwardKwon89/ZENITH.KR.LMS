...
| 074 | 출고·운송장 출력 화면 SCR-041 | B_Kai | ⬜ | — |
| 075 | 오더 패킹 화면 SCR-031 | B_Kai | ⬜ | — |
| 076 | 특수화물 기재 | Riley | ⬜ | — |
| 077 | 회원 관리 전용 화면 SCR-091 | D_Kai | ⬜ | — |
...
| Phase | 완료 | 전체 | 진행률 | 비고 |
|:-----:|:----:|:----:|:------:|:-----|
| A | 7 | 9 | 77.8% | IMP-071·072 🔔 (P0 보안, TASK-068 완료) |
...
> 미완료 IMP 9건: IMP-071·072(🔔 검토 대기) · IMP-073(🔔 검토 대기) · IMP-074~077(⬜ 미착수) · IMP-046(🚫 유예) · IMP-028(⬜ Future) · IMP-069(🚫 착수 조건 대기)
> 2026-05-23 기준 업데이트 (Riley - TASK-069 완료 보고)
