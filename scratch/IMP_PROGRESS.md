...
| 052 | dissolveMasterOrder 부분 실패 | Riley | 🔔 | 2026-05-21 |
...
| 023 | i18n 번역 키 타입 안정성 | D_Kai | 🔔 | 2026-05-21 |
| 024 | 공통 UI 컴포넌트 라이브러리화 | Ring | ⬜ | — |
| 027 | 점검 모드 페이지 | B_Kai | ✅ | 2026-05-15 |
| 029 | TS 타입 안전성 (any 퇴출) | D_Kai | 🔔 | 2026-05-21 |
| 032 | 다국어 번역 커버리지 감사 + CI 게이트 | B_Kai | ✅ PASS | 2026-05-21 |
| 049 | 이중 프로필 테이블 정리 | D_Kai | ⬜ | — |
| 050 | HELD→이전상태 복구 로직 | Riley | 🔔 | 2026-05-21 |
| 060 | RETURNED 상태 전이 확장 | Ring | 🔔 | 2026-05-21 |
| 061 | PDF 경로 충돌 방지 | B_Kai | 🔔 | 2026-05-21 |

**Phase F 완료**: 6 / 12 (50%) → 3건(IMP-023·029·061) 검토 대기
