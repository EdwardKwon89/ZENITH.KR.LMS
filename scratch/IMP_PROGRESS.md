...
| **Phase 7** | 5 | 9 | 55.6% | **IMP-110 ✅** UPS DB 스키마 7종 (aca457e) · **IMP-111 ✅** Agency 역할 모델 (dc8a2ff) · **IMP-112 ✅** UPS 요금 계산 엔진 (e60fff0 Aiden·fee7bf1 D_Kai·b315d49+6870271 B_Kai — Aiden ✅ 승인 260615) · **IMP-113 ✅** UPS 요율 Admin UI (TASK-146, 0578fb7, B_Kai — Aiden ✅ 승인 260616) · **IMP-114 ⬜** Agency 화주 관리 UI (TASK-142) · **IMP-115 ⬜** IBC/Pactrak Interface (SPR-05) · **IMP-117 🔔** 간이 UPS 인보이스 PDF (TASK-148, B_Kai — UpsInvoicePDF.tsx + TC-UPS-INV-01~02) · **IMP-118 🔔** 오더 직접배송/픽업 UI (TASK-149, Riley) · **IMP-119 🔔** 창고 출고 UPS 연계 (b7736c3 D_Kai, MVP — intl_ref_no 표시 + 경고 다이얼로그) |
| **합계** | **96** | **103** | **93.2%** | IMP-117~119 ⬜ 신규 등재 (260616) · IMP-113 ✅ (260616) · IMP-109 ✅ (260616) · IMP-112 ✅ (260615) · IMP-111 ✅ (260614) · IMP-110 ✅ (260614) |
