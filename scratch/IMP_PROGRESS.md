...
| 039 | 정산 이중 실행 방지 | Riley | 🔔 | 2026-05-20 |
| 040 | WAREHOUSED→CANCELED 재고 불일치 | Riley | 🔔 | 2026-05-20 |
...
| 033 | Server Actions 도메인 분할 | B_Kai | 🔔 | 2026-05-20 |
...
| 067 | Server Action 입력 Zod 검증 부재 (6개 액션) | Ring | 🔔 | 2026-05-20 |
...
> ⚠️ 합계 57개 = 완료 17개(+IMP-014·058·062) + 검토대기 1개(IMP-033) + 미착수 39개 (IMP-018·034b 제외)
