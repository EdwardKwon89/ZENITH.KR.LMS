...
| **Phase 7** | 5 | 6 | 83.3% | **IMP-110 ✅** UPS DB 스키마 7종 (aca457e) · **IMP-111 ✅** Agency 역할 모델 (dc8a2ff) · **IMP-112 ✅** UPS 요금 계산 엔진 (e60fff0 Aiden·fee7bf1 D_Kai·b315d49+6870271 B_Kai — Aiden ✅ 승인 260615) · **IMP-113 🔔** UPS 요율 Admin UI (TASK-146, 0578fb7, B_Kai — 재작업: dialog/table/tabs + ZenUI props fix · 회귀 65/65 PASS) · **IMP-114 ⬜** Agency 화주 관리 UI (TASK-142) · **IMP-115 ⬜** IBC/Pactrak Interface (SPR-05) |
| **합계** | **95** | **100** | **95.0%** | IMP-112 ✅ (260615) · IMP-112~116 신규 등재 (SPR-02~06 예정) · IMP-111 ✅ (260614) · IMP-110 ✅ (260614) |
