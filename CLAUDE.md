...
### R-15 | 개선 사항 도출 및 기록 의무 (Improvement Logging)

작업 수행 중 즉시 수정이 불가하거나 별도 계획이 필요한 개선 사항(기능 결함, 구조적 한계, 기술 부채 등)을 발견한 경우, **반드시** `scratch/post_launch_improvements.md` 파일에 즉시 기록합니다.
...
| v1.3 | 2026-05-08 | Claude (Aiden) | 개선 사항 도출 및 기록 의무 R-15 추가 (GEMINI.md v1.14 동기화)              |
