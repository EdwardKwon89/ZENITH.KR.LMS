...
const SUPABASE_SERVICE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImV4cCI6MTk4MzgxMjk5Nn0.EGIM96RAZx35l2aKZr6D0PLA05N1R9N0IypxOFZSFJc';
...
test.describe('UAT-17-03: 대리점 화주 요율 오버라이드가 적용된 UPS 요금 계산 검증', () => {
  ...
  test('대리점 Rate Override 반영 확인 — UPS Express 오더 등록', async ({ page }) => {
    ...
    if (overrides && overrides.length > 0) {
      ...
      console.warn('[UAT-17-03] No override found for agency org - may need 2 setup first');
    }
